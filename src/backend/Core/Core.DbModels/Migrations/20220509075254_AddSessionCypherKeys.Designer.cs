...
namespace Core.DbModels.Migrations
{
    ...
    [Migration("20220509075254_AddSessionCypherKeys")]
    partial class AddSessionCypherKeys
    {
            ...
            modelBuilder.Entity("Core.DbModels.UserCypherKey", b =>
                {
                    ...
                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("SessionId"), new[] { "CryptdedKey" });
